...
public class flipkart extends AppCompatActivity {
    ...
    public void f(View view) {
        ...
        text.setText(ss);
        correct();
        Button fff = (Button) findViewById(R.id.fff);
        fff.setEnabled(false);
    }
    ...
    public void retry(View view){
        ...
        ddd.setEnabled(true);
        Button dddd = (Button) findViewById(R.id.rrr);
        ddd.setEnabled(true);
        Button ddddd = (Button) findViewById(R.id.kkk);
        ddd.setEnabled(true);
    }
